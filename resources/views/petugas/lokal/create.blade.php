...
@section('title', 'Tambah Data Wisatawan Lokal')
  ...
  @parent
    ...
    <div class="">
      <ul class="breadcrumbs-alt">
          ...
          <li>
              <a href="" class="current">Wisatawan Lokal</a>
          </li>
      </ul>
    </div>
...
<form class="form-horizontal" id="signupForm" role="form" action="../../petugas/lokal" method="post" >
            ...
            <div class="form-group {{ $errors->has('objek') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmlobjek" class=""> orang
                      </div>
    ...
    <div class="panel panel-info">
      ...
      <div class="well">
        <div class="panel-body">
          <div class="alert alert-info fade in">
            <i class="fa fa-info-circle "></i> 
            Silakan pilih salah satu provinsi.
            <br>Kolom ini <b>dibutuhkan.</b>
          </div>
                    ...
                    <select class="form-control" name="provinsi" >
                        <option value="">- Pilih Provinsi -</option>
                          @foreach($provinsis as $provinsi)
                            <option value="{{$provinsi->kode}}" @if(old('provinsi')&&old('provinsi') == $provinsi->kode) selected="selected" @endif> {{$provinsi->nama_kriteria_sub}} </option>
                          @endforeach
                    </select>
            ...
            <div class="form-group {{ $errors->has('jk1') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmljk1"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('jk2') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmljk2"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('tujuan1') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmltujuan1"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('tujuan2') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmltujuan2"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('tujuan3') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmltujuan3"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('tujuan4') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmltujuan4"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('umur1') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmlumur1"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('umur2') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmlumur2"> orang
                      </div>
                    </div>
            ...
            <div class="form-group {{ $errors->has('umur3') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-md-10">
                      <label for="" class="col-lg-2 col-sm-2 form-controlol-label">Jumlah *</label>
                      <div class="col-md-6">
                        <input type="number" class="form-control" name="jmlumur3"> orang
                      </div>
                    </div>
