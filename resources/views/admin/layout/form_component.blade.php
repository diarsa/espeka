...
<head>
    ...
    <link href="{{ asset ('assets/admin/js/iCheck/skins/minimal/red.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/minimal/green.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/minimal/blue.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/minimal/yellow.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/minimal/purple.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset ('assets/admin/js/iCheck/skins/square/green.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/square/blue.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/square/yellow.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/square/purple.css') }}" rel="stylesheet">

    <link href="{{ asset ('assets/admin/js/iCheck/skins/flat/grey.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/flat/red.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/flat/green.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/flat/blue.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/flat/yellow.css') }}" rel="stylesheet">
    <link href="{{ asset ('assets/admin/js/iCheck/skins/flat/purple.css') }}" rel="stylesheet">
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset ('assets/admin/https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js') }}"></script>
    <script src="{{ asset ('assets/admin/https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js') }}"></script>
    <![endif]-->
</head>
