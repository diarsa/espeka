    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" align="center">Daftar Administrator</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" name="password_confirmation" required="password">
                        ...
                        <div class="form-group{{ $errors->has('jabatan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                              <select class="form-control" name="jabatan" required="required">
                                ...
                                <option value="Analisa Pasar">Analisa Pasar</option>
                              </select>
