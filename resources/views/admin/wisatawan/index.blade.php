...
@section('title', 'Wisatawan Mancanegara')
...
@section('header')
  ...
  <div class="">
    <ul class="breadcrumbs-alt">
        ...
        <li>
            <a href="{{URL('admin/wisatawan')}}" class="current">Wisatawan Mancanegara</a>
        </li>
    </ul>
  </div>
...
<tr class="gradeX">
  <td>{{{ date('d M Y' , strtotime($wisata->created_at) )}}} pukul {{ date('H:i' , strtotime($wisata->created_at) )}}</td>
  <td>{{{ $wisata->nama }}}</td>
