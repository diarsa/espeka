...
@section('title', "News Detail - $berita->title")
  						...
  						<div class="blog_single">
  							<article class="post">
  								<figure class="post_img">
  									<a href="#">
  										<img src="{{asset(('assets/images/blog/blog_1.png'))}}" alt="blog post">
  									</a>
  								</figure>
  								<div class="post_date">
  								...
  								<div class="post_content">
  									<div class="post_meta">
  										...
  										<div class="metaInfo">
  											...
  											<span><i class="fa fa-user"></i> By Louis </span>
                                      ...
                                      <div  class="tab-content clearfix">
                                          <div class="tab-pane fade active in" id="Popular">
                                              <ul class="recent_tab_list">
                                                  <li>
                                                      <span><a href="#"><img src="{{asset(('assets/images/content/recent_1.png'))}}" alt="" /></a></span>
                                                      <a href="#">Publishing packag esanse web page editos</a>
                                                      <i>October 09, 2015</i>
                                                  </li>
                                                  <li>
                                                      <span><a href="#"><img src="{{asset(('assets/images/content/recent_2.png'))}}" alt="" /></a></span>
                                                      <a href="#">Sublishing packag esanse web page editos</a>
                                                      <i>October 08, 2015</i>
                                                  </li>
                                                  <li class="last-tab">
                                                      <span><a href="#"><img src="{{asset(('assets/images/content/recent_3.png'))}}" alt="" /></a></span>
                                          ...
                                          <div class="tab-pane fade" id="Recent">
                                              <ul class="recent_tab_list">
                                                  <li>
                                                      <span><a href="#"><img src="{{asset(('assets/images/content/recent_4.png'))}}" alt="" /></a></span>
                                                      <a href="#">Various versions has evolved over the years</a>
                                                      <i>October 18, 2015</i>
                                                  </li>
                                                  <li>
                                                      <span><a href="#"><img src="{{asset(('assets/images/content/recent_5.png'))}}" alt="" /></a></span>
                                                      <a href="#">Rarious versions has evolve over the years</a>
                                                      <i>October 17, 2015</i>
                                                  </li>
                                                  <li class="last-tab">
                                                      <span><a href="#"><img src="{{asset(('assets/images/content/recent_6.png'))}}" alt="" /></a></span>
