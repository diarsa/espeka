<?php $__env->startSection('title', 'Wisatawan Mancanegara'); ?>
...
<?php $__env->startSection('header'); ?>
  ...
  <div class="">
    <ul class="breadcrumbs-alt">
        ...
        <li>
            <a href="<?php echo e(URL('admin/wisatawan')); ?>" class="current">Wisatawan Mancanegara</a>
        </li>
    </ul>
  </div>
...
<tr class="gradeX">
  <td><?php echo e(date('d M Y' , strtotime($wisata->created_at) )); ?> pukul <?php echo e(date('H:i' , strtotime($wisata->created_at) )); ?></td>
