...
<div class="" align="right">
  <form class="" action="<?php echo e(url('/petugas/objek/create')); ?>">
...
<tr class="gradeX">
  ...
  <td>
    <form class="" action="<?php echo e(url('/petugas/objek', $objek->id)); ?>" method="get">
  ...
  <td>
    <form class="" action="<?php echo e(url('/petugas/objek', $objek->id)); ?>/edit" method="get">
  ...
  <td>
    <button class="btn btn-danger" name="button" title="Hapus" method="get" data-toggle="modal" data-target="#deleteModal<?php echo e($objek->id); ?>" onclick="javascript: <?php echo e(url('/petugas/objek/'.$objek->id)); ?>"><i class="fa fa-trash-o fa-lg"></i>
    </button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form class="" action="<?php echo e(url('/petugas/objek', $objek->id)); ?>" method="post">
