<?php $__env->startSection('title', 'Buat Objek Wisata'); ?>
...
<?php echo $__env->make('admin.layout.googlemap', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="">
      <ul class="breadcrumbs-alt">
          ...
          <li>
              <a href="<?php echo e(URL('admin/objek')); ?>">Objek Wisata</a>
          </li>
          <li>
...
<div class="position-left">
  <form class="form-horizontal" id="signupForm" role="form" action="../objek" method="post" enctype="multipart/form-data">
    <div class="form-group <?php echo e($errors->has('nama_objek') ? ' has-error' : ''); ?>">
        ...
        <div class="col-lg-10">
            <input class="form-control" type="text" name="nama_objek" value="<?php echo e(old('nama_objek')); ?>" placeholder="Masukkan nama objek wisata di sini" required="required">
          ...
          <select class="form-control" name="kategori" required="required">
            <option value="">- Pilih Kategori -</option>
              <?php foreach($kats as $kat): ?>
                <option value="<?php echo e($kat->id); ?>" <?php if(old('kategori')&&old('kategori') == $kat->id): ?> selected="selected" <?php endif; ?>> <?php echo e($kat->nama_kat); ?> </option>
              <?php endforeach; ?>
          </select>
    ...
    <div class="form-group<?php echo e($errors->has('keterangan') ? ' has-error' : ''); ?>">
        ...
        <div class="col-lg-10">
            <textarea id="messageArea" class="form-control ckeditor" name="keterangan" rows="7" placeholder="Masukkan deskripsi singkat di sini" required="required"><?php echo e(old('keterangan')); ?></textarea>
        ...
        <div class="col-lg-10">
          <select class="form-control" name="status" required="required">
            <option value="">- Pilih Status -</option>
              <option value="Tampil" <?php if(old('status')&&old('status')=='Tampil'): ?> selected="selected" <?php endif; ?>> Tampil </option>
              <option value="Sembunyi" <?php if(old('status')&&old('status')=='Sembunyi'): ?> selected="selected" <?php endif; ?>> Sembunyi </option>
          </select>
    ...
    <label for="image" class="col-lg-2 control-label">Gambar 1 *</label>
      <div class="col-lg-10">
        <input class="form-control" type="file" name="image" value="<?php echo e(old('image')); ?>">
        <p class="help-block">
    ...
    <label for="image2" class="col-lg-2 control-label">Gambar 2 *</label>
      <div class="col-lg-10">
        <input class="form-control" type="file" name="image2" required="required" value="<?php echo e(old('image2')); ?>">
        <p class="help-block">
          Ukuran 900x500 pixel
        </p>
    ...
    <label for="image3" class="col-lg-2 control-label">Gambar 3 *</label>
      <div class="col-lg-10">
        <input class="form-control" type="file" name="image3" required="required" value="<?php echo e(old('image3')); ?>">
        <p class="help-block">
          Ukuran 900x500 pixel
        </p>
    ...
    <label for="img_slider" class="col-lg-2 control-label">Slider Gambar</label>
      <div class="col-lg-10">
        <input class="form-control" type="file" name="img_slider" value="<?php echo e(old('img_slider')); ?>">
        <p class="help-block">
    ...
    <div class="form-group<?php echo e($errors->has('sumber_gambar') ? ' has-error' : ''); ?>">
        ...
        <div class="col-lg-10">
            <input class="form-control" type="text" name="sumber_gambar" value="<?php echo e(old('sumber_gambar')); ?>" placeholder="Masukkan sumber gambar di sini" required="required">
...
<?php /*
    <div class="form-group<?php echo e($errors->has('map') ? ' has-error' : ''); ?>">
        ...
        <div class="col-lg-10">
            <textarea id="messageArea" class="form-control" name="map" rows="3" placeholder="Masukkan embed map di sini" required="required"><?php echo e(old('map')); ?></textarea>
        ...
        <div class="col-lg-10">
              <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <input type="text" name="alamat" id="searchmap" class="form-control" required="" value="<?php echo e(old('alamat')); ?>">
